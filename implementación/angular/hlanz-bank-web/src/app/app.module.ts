...
import { HandleError } from './shared/services/error-handler.service';
...
@NgModule({
  ...
  providers: [UserService, CuentasService, MovimientosService, 
              AuthGuardService, AdminGuardService ,AlertService, NoticiasService,
              TerminosService, HandleError, CookieService
            ],

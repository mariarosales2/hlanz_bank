...
public class MovimientosDAOImpl extends BaseDAOImpl implements MovimientosDAO{
	...
	public List<Movimientos> buscarMovimientos(int cuenta) {
		String consulta = "select o from Movimientos as o where "
				+ "( cuentasByCuentaEmisora.idCuenta = :cuenta AND movimiento < 0 )"
				+ "OR ( cuentasByCuentaReceptora.idCuenta = :cuenta AND movimiento > 0)";
